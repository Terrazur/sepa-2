<div>
	<ul class="navbar navbar-black uncollapse">
		<li class="nav-item nav-item-left "><a href="/sepa2" class="item">Home</a></li>
...
<div>
	<ul class="navbar navbar-transparent collapse" style="text-align: left;">
		...
		<div class="show">
			<li class="nav-item"><a href="/sepa2" class="item">Home</a></li>
